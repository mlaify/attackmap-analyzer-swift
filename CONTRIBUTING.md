# Contributing to `attackmap-analyzer-swift`
...
```bash
git clone https://github.com/mlaify/attackmap-analyzer-swift.git
cd attackmap-analyzer-swift
python -m venv .venv
...
Open a [bug report](https://github.com/mlaify/attackmap-analyzer-swift/issues/new?template=bug_report.md).
...
Open a [feature request](https://github.com/mlaify/attackmap-analyzer-swift/issues/new?template=feature_request.md).
...
By contributing to `attackmap-analyzer-swift`, you agree that your contributions will be
